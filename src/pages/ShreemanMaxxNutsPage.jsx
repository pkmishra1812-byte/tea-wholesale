// src/pages/ShreemanMaxxNutsPage.jsx
import { Link } from "react-router-dom";
import nutsBanner from "../assets/banner-new-4.png";
import almondImg from "../assets/banner-new-1.png";
import cashewImg from "../assets/banner-new-3.png";
import walnutImg from "../assets/banner-new-4.png";
...
const NUT_VARIANTS = [
  {
    title: "Almonds",
    name: "Almonds",
    imgs: [almondImg, cashewImg, walnutImg],
  },
  {
    title: "Cashews",
    name: "Cashews",
    imgs: [cashewImg, walnutImg, almondImg],
  },
  {
    title: "Walnuts",
    name: "Walnuts",
    imgs: [walnutImg, almondImg, cashewImg],
  },
  {
    title: "Pistachios",
    name: "Pistachios",
    imgs: [almondImg, walnutImg, cashewImg],
  },
];

const PACK_SIZES = ["200 g", "500 g", "1 kg"];
...
export default function ShreemanMaxxNutsPage() {
  return (
    <>
      {/* ── Banner ── */}
      ...
      <section className="bg-white py-16 lg:py-20">
        <div className="max-w-screen-xl mx-auto px-6 lg:px-8">
          ...
          <p className="font-body text-[#666] text-lg leading-[1.6] max-w-3xl">
            Nature's finest, handpicked for purity and crunch — Shreeman Maxx Nuts bring premium almonds, cashews, walnuts, and pistachios to your everyday moments. Each pack celebrates wholesome richness, making every snack a nourishing ritual of taste and vitality.
          </p>
        </div>
      </section>

      {/* ── Nut Variant Sections ── */}
      {NUT_VARIANTS.map((variant) => (
        <PackSection
          key={variant.title}
          title={variant.title}
        ...
        <div className="max-w-screen-xl mx-auto px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-[45fr_55fr] gap-10 lg:gap-16 items-start">
            <h2 className="font-display text-[#1a1a2e] text-3xl sm:text-4xl xl:text-[42px] font-normal leading-[1.3]">
              Make every moment a celebration of pure goodness.
            </h2>
