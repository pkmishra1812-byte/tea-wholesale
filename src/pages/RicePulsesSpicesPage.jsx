// src/pages/RicePulsesSpicesPage.jsx
import { Link } from "react-router-dom";
import rpsBanner from "../assets/banner-new-3.png";
import riceImg from "../assets/banner-new-1.png";
import pulsesImg from "../assets/banner-new-4.png";
import wholeImg from "../assets/banner-new-2.png";
import groundImg from "../assets/banner-new-3.png";
import ExploreCategories from "../components/shared/ExploreCategories";

const STAPLE_SIZES = ["1 kg", "5 kg", "10 kg"];
const SPICE_SIZES = ["100 g", "250 g", "500 g"];

const packData = [
  {
    title: "Rice",
    name: "Shreeman Premium Rice",
    sizes: STAPLE_SIZES,
    imgs: [riceImg, pulsesImg, groundImg],
  },
  {
    title: "Pulses",
    name: "Shreeman Premium Pulses",
    sizes: STAPLE_SIZES,
    imgs: [pulsesImg, groundImg, riceImg],
  },
  {
    title: "Whole Spices",
    name: "Shreeman Whole Spices",
    sizes: SPICE_SIZES,
    imgs: [wholeImg, groundImg, pulsesImg],
  },
  {
    title: "Ground Spices",
    name: "Shreeman Ground Spices",
    sizes: SPICE_SIZES,
    imgs: [groundImg, wholeImg, riceImg],
  },
];
...
export default function RicePulsesSpicesPage() {
  return (
    <>
      {/* ── Banner ── */}
      ...
      <section className="bg-white py-16 lg:py-20">
        <div className="max-w-screen-xl mx-auto px-6 lg:px-8">
          ...
          <p className="font-body text-[#666] text-lg leading-[1.6] max-w-3xl">
            The heart of every Indian kitchen — fragrant rice, protein-rich pulses, and spices bursting with aroma. Sourced directly from farms and prepared with care, our range brings authenticity, purity, and warmth to every dish.
          </p>
        </div>
      </section>
        ...
        <div className="max-w-screen-xl mx-auto px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-[45fr_55fr] gap-10 lg:gap-16 items-start">
            <h2 className="font-display text-[#1a1a2e] text-3xl sm:text-4xl xl:text-[42px] font-normal leading-[1.3]">
              Authentic flavour, from our farms to your kitchen.
            </h2>
