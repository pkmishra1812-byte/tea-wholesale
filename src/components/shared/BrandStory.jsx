...
function BrandStory() {
  ...
  return (
    <section
      className="pt-14 lg:pt-20 pb-10 lg:pb-14"
      style={{ backgroundColor: "#FDF6EC" }}
    >
      <div className="relative z-10 max-w-screen-xl mx-auto px-6 lg:px-8 pt-4 lg:pt-8">
        {/* Heading */}
        <h2 className="font-display text-black text-3xl lg:text-4xl font-bold leading-tight">
          Every Tea Has A Story
        </h2>

        {/* Paragraph */}
        <p className="font-body text-gray-600 leading-relaxed mt-6 w-full max-w-[1170px] lg:text-lg">
